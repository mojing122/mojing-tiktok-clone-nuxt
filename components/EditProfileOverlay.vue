<template>
  ...
  >
    ...
    >
      ...
      >
        <div class="text-[22px] font-medium">编辑资料</div>
            ...
            <div class="flex items-center justify-center sm:-mt-6">
              <div class="sm:w-[60%] w-full max-w-md">
                ...
                <div class="text-[11px] text-gray-500 mt-4">
                  用户名只能包含汉字、字母、数字、下划线和句号。更改您的用户名也会更改您的个人资料链接。
                </div>
              </div>
            </div>
          </div>
      ...
      >
        ...
        >
          ...
          >
            <span class="px-4 font-medium text-[15px]">取消</span>
          </button>
          ...
          >
            <span class="mx-5 font-medium text-[15px]">保存</span>
          </button>
        </div>
        ...
        <div id="CropperButtons" v-else class="flex items-center justify-end">
          ...
          <button
            ...
            class="flex items-center bg-[#F02C56] text-white border rounded-md ml-3 px-3 py-[6px]"
          >
            <span class="mx-5 font-medium text-[15px]">应用</span>
          </button>
        </div>
      </div>
    </div>
