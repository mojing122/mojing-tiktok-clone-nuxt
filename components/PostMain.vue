    ...
    <div class="pl-3 w-full px-4">
      <div class="flex items-center justify-between pb-0.5">
        <button @click="isLoggedIn(post.user)">
          ...
          <span
            class="text-[13px] font-light text-gray-500 pl-1 cursor-pointer"
      ...
      <div class="text-[14px] pb-0.5 flex items-center font-semibold">
        ...
        <div class="px-1">{{ post.user.name }} 的视频原声</div>
      ...
      <div class="mt-2.5 flex">
        <div
          ...
          class="relative min-h-[480px] mxa-h-[580px] max-w-[260px] flex items-center bg-black rounded-xl cursor-pointer"
        >
          <video
            v-if="post.video"
            ref="video"
        ...
        <div class="relative mr-[75px]">
          <div class="absolute bottom-0 pl-2">
            ...
            <div class="pb-4 text-center">
              ...
              <span class="text-xs text-gray-800 font-semibold">7</span>
            </div>
          </div>
        </div>
      </div>
