    ...
    >
      ...
      >
        ...
        >
          ...
          <span class="px-2 font-medium text-[15px]">上传视频</span>
        </button>

        <div v-if="!$userStore.id" class="flex items-center">
          <button
            @click="(event) => ($generalStore.isLoginOpen = true)"
            class="flex items-center bg-[#F02C56] text-white border px-3 py-[6px] rounded-md"
          >
        ...
        <div v-else class="flex items-center">
          ...
          <div class="relative">
            ...
            <div
              ...
              class="absolute bg-white rounded-lg py-1.5 w-[180px] shadow-xl border top-[43px] -right-2"
            >
              <NuxtLink
              ...
              >
                ...
                <span class="pl-2 font-semibold text-sm">个人资料</span>
              </NuxtLink>
              <div
                @click="logout()"
              ...
              >
                ...
                <span class="pl-2 font-semibold text-sm">登出</span>
              </div>
            </div>
          </div>
        </div>
