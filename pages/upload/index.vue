  ...
  <UploadLayout
    ...
    >
      <div>
        ...
        <div class="text-gray-400 mt-1">上传视频到你的账号</div>
      </div>
      <div class="mt-8 md:flex gap-6">
        ...
        >
          ...
          <div class="mt-4 text-[17px]">选择上传一个视频</div>
          <div class="mt-1.5 text-gray-500 text-[13px]">
            或者直接将文件拖拽到窗口
          </div>
          <div class="mt-12 text-gray-400 text-sm">MP4格式</div>
          <div class="mt-2 text-gray-400 text-[13px]">视频不超过30分钟</div>
          <div class="mt-2 text-gray-400 text-[13px]">文件大小小于2GB</div>
          <div
          ...
          >
            <div class="flex items-center truncate">
              <Icon
                ...
                class="min-w-[16px]"
              />
              <div class="text-[11px] pl-1 truncate text-ellipsis w-[200px]">
                {{ fileData.name }}
              </div>
            </div>
            <button
              @click="clearVideo()"
              class="text-[11px] ml-2 font-semibold w-[60px]"
            >
              更换视频
            </button>
          </div>
        ...
        <div class="mt-4 mb-6">
          <div class="flex bg-[#F8F8F8] py-4 px-6">
            ...
            <div>
              <div class="text-semibold text-[15px] mb-1.5">分割/编辑视频</div>
              <div class="text-semibold text-[13px] text-gray-400">
                您可以快速将视频分成多个部分，去除多余部分，将风景视频变成人像视频
              </div>
            </div>
            <div
          ...
          <div class="mt-5">
            <div class="flex items-center justify-between">
              <div class="mb-1 text-[15px]">视频标题</div>
